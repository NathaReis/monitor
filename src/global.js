...
function createTheme(localTheme) {
    const theme = document.createElement("div");
    const svgTheme = {
        light: 
        `<svg xmlns="http://www.w3.org/2000/svg" class="bi bi-lamp-fill" viewBox="0 0 16 16">
        ...
        dark: 
        `<svg xmlns="http://www.w3.org/2000/svg" class="bi bi-lamp" viewBox="0 0 16 16">
    ...
    const isLightTheme = {light: true}

    theme.innerHTML = svgTheme[localTheme];
    ...
    isLightTheme[localTheme] ? $html.classList.add("light") : $html.classList.remove("light");
}

function getTheme() {
    const theme = localStorage.getItem("theme");
    createTheme(theme ? theme : 'light');
}
getTheme();