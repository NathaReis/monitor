export class ThemeService {
    ...
    constructor(header, html) {
        this.$header = header,
        this.$html = html,
        this.create = (localTheme) => {
            ...
            this.$header.appendChild(theme);
        
            isLightTheme[localTheme] ? this.$html.classList.add("light") : this.$html.classList.remove("light");
        };
    }
    
    getTheme() {
        const theme = localStorage.getItem("theme");
        this.create(theme ? theme : 'light');
    }
}